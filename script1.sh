...
# Author: Nikhil Kumar Mishra | Reg No: 24BSA10179 | Course: Open Source
Software
# Description: Displays a formatted system welcome screen with OS, user, and
MySQL info
STUDENT_NAME="Nikhil Kumar Mishra"
